...
#script4
#1-ое задание
cat $(ls -R | grep 'm$') | wc -m > /tmp/res1.txt
...
#unix timestep следующее задание можно переделать с его помощью
#4
ls -d * */* */*/* --time=modify 2>/tmp/errors.txt | sort -k6,7 | tail -n 4
...
# номер варианта 2-ой лабы 1000 + номер 1-ой