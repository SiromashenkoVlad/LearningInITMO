...
public class CountGreaterThanLocationCollectionCommand extends CollectionCommand {
    public CountGreaterThanLocationCollectionCommand(CollectionManager collectionManager){
