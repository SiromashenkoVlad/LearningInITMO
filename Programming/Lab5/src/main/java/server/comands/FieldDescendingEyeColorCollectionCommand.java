...
public class FieldDescendingEyeColorCollectionCommand extends CollectionCommand {
    public FieldDescendingEyeColorCollectionCommand(CollectionManager collectionManager){
